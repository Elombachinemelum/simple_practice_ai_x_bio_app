...
export default function Home() {
  return (
    <main className="grid grid-cols-2 relative gap-12 p-24 border-[1px]">
      <div className="group col-span-2 text-center border-[1px]">
        ...
        <h1 className="font-extrabold text-7xl text-center w-full lg:w-[90%] uppercase mx-auto py-6">
